...
const GAME_CONFIG = {
    ...
    // ── Drill Layouts ─────────────────────────────────────────
    // Each mode has a pool of positions. On spawn, randomly select a subset.
    DRILLS: {
        static: [
            // Pool of 12 positions, spawn 5 randomly each round
            { x: -0.3, y: 0, d: 0.10 },
            { x:  0.4, y: 0, d: 0.25 },
            { x:  0.0, y: 0, d: 0.45 },
            { x: -0.5, y: 0, d: 0.60 },
        ...
        strafe: [
            // Pool of 12 positions, spawn 5 randomly
            { x: -0.5, y: 0, d: 0.10 },
            { x:  0.4, y: 0, d: 0.25 },
            { x: -0.2, y: 0, d: 0.45 },
            { x:  0.6, y: 0, d: 0.60 },
        ...
        micro: [
            // Pool of 10 positions, spawn 6 randomly
            { x: -0.4, y: 0, d: 0.35 },
            { x:  0.4, y: 0, d: 0.45 },
            { x:  0.0, y: 0, d: 0.55 },
            { x: -0.6, y: 0, d: 0.65 },
